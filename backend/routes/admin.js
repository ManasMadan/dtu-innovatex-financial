...
router.get("/dashboard", async (req, res) => {
  ...
  let eventTypeVTime = {
    ...
    "auth-lockout": 0,
    "transaction-large": 0,
    "transaction-frequent": 0,
    "transaction-unusual-location": 0,
    "payee-added": 0,
    "customer-info-change": 0,
    "credit-limit-change": 0,
    "account-closure": 0,
    "wire-transfer-large": 0,
    "card-suspicious-activity": 0,
    "identity-theft-alert": 0,
    "phishing-report": 0,
    "insider-trading-suspicion": 0,
    "money-laundering-suspicion": 0,
  };
